...
namespace Veterinarias.Controllers
{
    public class VeterinariosController : Controller
    {
        ...
        {
            var guid = Guid.NewGuid().ToString();//GUID: crear codigo alfanumerico
            var fileName = guid + Path.GetExtension(FotoIFormFile.FileName);
            //Obtengo extension del documento
            var carga1 = Path.Combine(_webHostEnvironment.WebRootPath, "images", ruta);//se utiliza para combina todods los parametros para obtener una ruta de sistema
